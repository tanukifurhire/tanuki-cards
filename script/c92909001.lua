...
function s.thfilter(c)
	return c:IsAbleToHand() and (c:IsSetCard(0x1908) or c:IsSetCard(0x406) or c:IsSetCard(0xF9F))
end
function s.flipop(e,tp,eg,ep,ev,re,r,rp)
	...
	s.announce_filter={0x48,OPCODE_ISSETCARD,0x406,OPCODE_ISSETCARD,OPCODE_OR,TYPE_EXTRA,OPCODE_ISTYPE,OPCODE_AND,TYPE_SKILL,OPCODE_ISTYPE,OPCODE_NOT,OPCODE_AND,TYPE_ACTION,OPCODE_ISTYPE,OPCODE_NOT,OPCODE_AND}
